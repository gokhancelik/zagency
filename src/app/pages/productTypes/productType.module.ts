...
import {
    routing, ProductTypeListComponent, ProductTypeComponent,
    ProductTypeEditComponent, ProductTypeAddComponent
} from './index';
...
@NgModule({
    ...
    exports: [],
    declarations: [ProductTypeListComponent, ProductTypeComponent,
        ProductTypeEditComponent, ProductTypeAddComponent
    ],
    providers: [DynamicFormService, DynamicFormRelationService],
})
export default class ProductTypeModule { }
